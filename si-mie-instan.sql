...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1107532904ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=si-mie-instan&table=tb_pengiriman">`si-mie-instan`.`tb_pengiriman`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=si-mie-instan&table=tb_ekspedisi">`si-mie-instan`.`tb_ekspedisi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=si-mie-instan&table=tb_rute">`si-mie-instan`.`tb_rute`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=adi&table=biaya_produksi">`adi`.`biaya_produksi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=adi&table=bahan_baku">`adi`.`bahan_baku`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cia&table=pemesanan%2Btransportasi">`cia`.`pemesanan+transportasi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=si-mie-instan&table=jadwal">`si-mie-instan`.`jadwal`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=si-mie-instan&table=pengguna">`si-mie-instan`.`pengguna`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=si-mie-instan&table=tb_gudang">`si-mie-instan`.`tb_gudang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbb_2118003&table=tb_admin">`dbb_2118003`.`tb_admin`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="65646f39682d7632704f5f5b3a37583c">
...
</span><small>Setel ke 0 untuk menutup panel navigasi.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="247"><a class="restore-default hide" href="#NavigationWidth" title="Kembalikan nilai bawaan"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
